...
resultToggle.addEventListener("change", async (event) => {
    ...
    try {
        await fetch("http://localhost:3000/api/dashboard/manual-result-state", {
            method: "POST",
    ...
    saveManualResultButton.addEventListener('click', async () => {
        ...
        try {
            const response = await fetch('http://localhost:3000/api/dashboard/set-manual-result', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ isManualResultEnabled, selectedColor }),
            });
...
async function fetchManualResultState() {
    ...
    async function fetchActiveBets(betNumber) {
        try {
            const response = await fetch(`http://localhost:3000/api/dashboard/active-bets/${betNumber}`);
    ...
    async function fetchMoneyAddRequests() {
        try {
            const response = await fetch(`http://localhost:3000/api/add-money/requests/all`);
            const data = await response.json();
    ...
    async function handleMoneyAddAction(requestId, action) {
        try {
            const response = await fetch('http://localhost:3000/api/add-money/approve', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    async function handleWithdrawalAction(requestId, action) {
        try {
            const response = await fetch('http://localhost:3000/api/withdrawal/update-status', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ requestId, action }),
            });
    ...
    async function fetchCurrentUpiId() {
        try {
            const response = await fetch('http://localhost:3000/api/add-money/current-upi-id');
            const data = await response.json();
    ...
    updateUpiIdButton.addEventListener('click', async () => {
        ...
        try {
            const response = await fetch('http://localhost:3000/api/add-money/update-upi-id', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
