...
async function fetchCurrentBetNumber() {
    try {
        const response = await fetch('http://localhost:3000/api/dashboard/current-bet-number');
...
async function updateCurrentBetNumber() {
    try {
        await fetch('http://localhost:3000/api/dashboard/update-bet-number', {
            method: 'POST',
...
async function savePlayerHistory(betNo, played, betAmount, status, amountWon, balanceAfterBet) {
    try {
        ...
        await fetch('http://localhost:3000/api/dashboard/player-history', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function fetchPlayerHistory() {
    try {
        const response = await fetch(`http://localhost:3000/api/dashboard/player-history/${username}`);
        const data = await response.json();
...
async function updateResultHistory(betNo, alphabet, color) {
    ...
    try {
        await fetch('http://localhost:3000/api/dashboard/result-history', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function fetchResultHistory() {
    try {
        const response = await fetch('http://localhost:3000/api/dashboard/result-history');
...
async function fetchUserBalance() {
    try {
        const response = await fetch(`http://localhost:3000/api/dashboard/balance/${username}`);
        const data = await response.json();
...
async function updateUserBalance(newBalance) {
    try {
        await fetch('http://localhost:3000/api/dashboard/balance', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function saveBetForAdmin(betData) {
    try {
        await fetch('http://localhost:3000/api/dashboard/active-bets', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function fetchTimerState() {
    try {
        const response = await fetch('http://localhost:3000/api/dashboard/timer-state');
        const data = await response.json();
...
async function updateTimerState(timeLeft, currentBetNumber) {
        try {
            await fetch("http://localhost:3000/api/dashboard/update-timer-state", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
...
async function fetchManualResultState() {
    try {
        const response = await fetch("http://localhost:3000/api/dashboard/manual-result-state");
